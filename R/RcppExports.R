...
computePopLDWindow <- function(chr, start_bp, end_bp, population_index, reference_index_file, reference_data_file, reference_pop_desc_file, maf_cutoff = NULL, missing_cutoff = NULL) {
